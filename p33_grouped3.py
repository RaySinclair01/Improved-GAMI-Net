...
# Group the data by 'group' column and get the mean for each group
...
for i, group in enumerate(groups):
    # Get the spectral data for the group
    spectral_data = grouped_data.loc[group, 325:1075]

    # Plot the data
    axes[i].plot(spectral_data.index, spectral_data.values, label=f'{group} group', color='blue')
