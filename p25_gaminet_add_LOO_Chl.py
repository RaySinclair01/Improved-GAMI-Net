...
# In[6]:初始化LeaveOneOut cross-validator
loo = LeaveOneOut()
# In[7]:设置超参数网格
param_grid = {
    'interact_num': [5],
...
grid_search = GridSearchCV(model_Chl, param_grid=param_grid, scoring=scorer, cv=loo, n_jobs=1, verbose=1)
...
model_Chl2.save(folder="./", name="model_Chl2_saved")
...
modelnew.load(folder="./", name="model_Chl2_saved")
